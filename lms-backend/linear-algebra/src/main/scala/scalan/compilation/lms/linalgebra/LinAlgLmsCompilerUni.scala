...
class LinAlgLmsCompilerUni[+ScalanCake <: ScalanDslExp with MatricesDslExp with JNIExtractorOpsExp](_scalan: ScalanCake) extends LmsCompilerUni[ScalanCake](_scalan) with LinAlgBridge {
