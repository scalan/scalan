...
trait FreesDslSeq extends ScalanDslSeq with impl.FreesSeq { self: MonadsDslSeq =>

}

trait FreesDslExp extends ScalanDslExp with impl.FreesExp { self: MonadsDslExp =>
