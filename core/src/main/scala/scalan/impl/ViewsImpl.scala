...
trait ViewsAbs extends Views {
  ...
  class IdentityIsoElem[A](val iso: Iso[IdentityIsoData[A], IdentityIso[A]])(implicit eA: Elem[A])
  ...
  // elem for concrete class
  class PairIsoElem[A1, A2, B1, B2](val iso: Iso[PairIsoData[A1, A2, B1, B2], PairIso[A1, A2, B1, B2]])(implicit eA1: Elem[A1], eA2: Elem[A2], eB1: Elem[B1], eB2: Elem[B2])
...
!!!("Cannot convert from IsoUR to PairIso: missing fields List(iso1, iso2)")
  ...
  // elem for concrete class
  class SumIsoElem[A1, A2, B1, B2](val iso: Iso[SumIsoData[A1, A2, B1, B2], SumIso[A1, A2, B1, B2]])(implicit eA1: Elem[A1], eA2: Elem[A2], eB1: Elem[B1], eB2: Elem[B2])
...
!!!("Cannot convert from IsoUR to SumIso: missing fields List(iso1, iso2)")
  ...
  // elem for concrete class
  class ComposeIsoElem[A, B, C](val iso: Iso[ComposeIsoData[A, B, C], ComposeIso[A, B, C]])(implicit eA: Elem[A], eB: Elem[B], eC: Elem[C])
...
!!!("Cannot convert from IsoUR to ComposeIso: missing fields List(iso2, iso1)")
  ...
  // elem for concrete class
  class FuncIsoElem[A, B, C, D](val iso: Iso[FuncIsoData[A, B, C, D], FuncIso[A, B, C, D]])(implicit eA: Elem[A], eB: Elem[B], eC: Elem[C], eD: Elem[D])
...
!!!("Cannot convert from IsoUR to FuncIso: missing fields List(iso1, iso2)")
  ...
  // elem for concrete class
  class ConverterIsoElem[A, B](val iso: Iso[ConverterIsoData[A, B], ConverterIso[A, B]])(implicit eA: Elem[A], eB: Elem[B])
...
!!!("Cannot convert from IsoUR to ConverterIso: missing fields List(convTo, convFrom)")
  ...
  // elem for concrete class
  class ListIsoElem[A, B](val iso: Iso[ListIsoData[A, B], ListIso[A, B]])(implicit eA: Elem[A], eB: Elem[B])
  ...
  // elem for concrete class
  class ArrayBufferIsoElem[A, B](val iso: Iso[ArrayBufferIsoData[A, B], ArrayBufferIso[A, B]])(implicit eA: Elem[A], eB: Elem[B])
  ...
  // elem for concrete class
  class ThunkIsoElem[A, B](val iso: Iso[ThunkIsoData[A, B], ThunkIso[A, B]])(implicit eA: Elem[A], eB: Elem[B])
